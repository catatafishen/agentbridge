#!/bin/sh
# =============================================================================
# Default-hook helper used by enforce-gh-bot-identity.js to generate a short-lived
# GitHub App installation token. Requires a GitHub App PEM key and App ID configured
# in ~/.agentbridge/ or via env vars. See docs/BOT-IDENTITY-HOOKS.md.
# =============================================================================
#
