...
public final class EditTextTool extends WriteFileTool {
    ...
    public @NotNull JsonObject inputSchema() {
        return schema(
            Param.optional("path", TYPE_STRING, "Path to the file to edit (absolute or project-relative). Also accepts 'file' as an alias. When omitted, edits the file open in the active editor."),
